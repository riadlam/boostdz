                ...
                <div className="rounded-2xl border border-[var(--color-dash-border)] bg-[var(--color-dash-surface)] p-6 shadow-sm md:p-8">
                    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                        ...
                        <button
                            type="submit"
                            disabled={submitting}
                            className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-primary text-[1rem] font-semibold text-primary-foreground transition hover:opacity-95 disabled:cursor-wait disabled:opacity-70"
                        >
                            {submitting ? (
                                <>
